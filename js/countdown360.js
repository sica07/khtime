;(function ($, window, document, undefined) {
    var pluginName = "countdown360",
        defaults = {
            ...
            fontFamily: "Helvetica",        // the font family
    ...
    Plugin.prototype = {
        ...
        _parseSeconds(seconds) {
            this.mins = 0;
            this.secs = 0;
            var minus =  false;
            if (seconds <= this.settings.seconds) {
            ...
            //spaces so that the whole text will not move when "-" is inserted
            this.secs += ' ';
            if (minus) {
                this.mins = '-' + this.mins;
            } else {
        ...
        _drawCountdownLabel: function (secondsElapsed) {
			...
			this._parseSeconds(this._secondsLeft(secondsElapsed));
				var secondsLeft = this.mins + ':' + this.secs,
        ...
        _draw: function () {
            ...
            this.settings.onTimeUpdate(remaining);
            if (secondsElapsed < this.settings.seconds) { this._drawCountdownShape(endAngle, true);
